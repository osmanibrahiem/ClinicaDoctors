...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static final String INTENT_SET_CIRCLE_IMAGE = "set_circle_image";
    ...
    private boolean lockAspectRatio = false, setBitmapMaxWidthHeight = false, setCircleImage = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            ToastTool.with(getApplicationContext(), getString(R.string.toast_image_intent_null)).show();
            return;
        }
        ...
        setCircleImage = intent.getBooleanExtra(INTENT_SET_CIRCLE_IMAGE, false);
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener) {
        ...
        SpannableString spannableString = new SpannableString(context.getString(R.string.lbl_set_profile_photo));
